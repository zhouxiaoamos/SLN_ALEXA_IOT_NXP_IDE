...
#define ACE_LOGV(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_VERBOSE, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGV(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOGD(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_DEBUG, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGD(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOGI(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_INFO, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGI(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOGW(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_WARN, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGW(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOGE(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_ERROR, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGE(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOGF(log_id, tag, fmt, ...) \
    aceLog_log(log_id, ACE_LOG_FATAL, tag, fmt, ##__VA_ARGS__)
#else
#define ACE_LOGF(log_id, tag, fmt, ...)
#endif
#endif
...
#define ACE_LOG_BASE(log_id, priority, tag, fmt, ...) \
    aceLog_log(log_id, priority, tag, fmt, ##__VA_ARGS__)
#endif
