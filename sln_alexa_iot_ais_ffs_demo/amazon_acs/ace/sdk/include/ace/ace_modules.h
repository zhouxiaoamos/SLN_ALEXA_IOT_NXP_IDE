...
typedef enum {
    ...
    ACE_MODULE_ACM = 36,             /** ACE Connectivity Manager */
    ACE_MODULE_AMA = 37,             /** Alexa Mobile Accessory */
    ACE_MODULE_ODOT = 38,            /** Messaging ODOT component */
    ACE_MODULE_PRIVACY_FILTER = 39,  /** Privacy Filter */
    ACE_MODULE_RPM = 40,             /** Radio Policy Manager */
    ACE_MODULE_DISPATCHER = 42,      /** ACE Dispatcher */
    ACE_MODULE_ACCESSORY_SDK = 43,   /** Accessory SDK */
