 ...
 * @note Use error codes mentioned to have cli module print out help for the
 * command
 * @retval   ACE_STATUS_OK if parameters were good.
 * @retval   ACE_STATUS_INCOMPATIBLE_PARAMS if parameters are not as expected.
 * @retval   ACE_STATUS_BAD_PARAM if parameters are invalid.
 * @retval   ACE_STATUS_NOT_SUPPORTED if functionality not supported.
 * @retval   ACE_STATUS_CLI_FUNC_ERROR for any other errors.
 */
