 ...
 * @param   attr A valid thread attriubute object
 ...
 * @retval  ERRCODE_INVALID_ARGUMENT   Invalid input paramters.  Thread
 ...
 *
 * @retval  ERRCODE_NO_ERROR  Function succeeded
 * @retval  ERRCODE_INVALID_ARGUMENT   Invalid input paramters
