...
/*!
 * @file    streamer_api.h
 * @brief   Streamer API header. Public APIs for using the af streamer
 *
 * @internal
 ...
 * After streamer processsed a message, it will signal the condition variable
 * in the message to make the function call sychronized.
 */
#define WAIT_STREAMER_MSG_RESPONSE_TIME_OUT  8000    /* 3s */
 ...
 */
 typedef enum {
    ...
    STREAM_ERR_ELEMENT_NOT_FOUND            = -10,
        /**< @brief Specfied element not found in pipeline. */
 ...
 * @details The type of pipeline in streamer
 */
typedef enum {
...
/*!
 * @brief DecoderType
 * @details Enumeration of potential media decoders
 */
typedef enum {
    DECODER_TYPE_UNKNOWN, /**< @brief unknown Decoder*/
    DECODER_TYPE_WAV,   /**< @brief Wave Decoder */
    DECODER_TYPE_MP3,   /**< @brief MP3 Decoder */
    DECODER_TYPE_MP2,   /**< @brief MP2 Decoder */
    DECODER_TYPE_AAC,   /**< @brief AAC Decoder */
    DECODER_TYPE_OGG,   /**< @brief OGG Decoder */
    DECODER_TYPE_WMA,   /**< @brief WMA Decoder */
    DECODER_TYPE_WMV,   /**< @brief WMV Decoder */
    DECODER_TYPE_MPEG2, /**< @brief MPEG2 Decoder */
    DECODER_TYPE_MPEG4, /**< @brief MPEG4 Decoder */
    DECODER_TYPE_JPEG,  /**< @brief JPEG Decoder */
    DECODER_TYPE_CD_DA, /**< @brief CD-DA tracks */
    DECODER_TYPE_MFI,   /**< @brief MFI device tracks */
    DECODER_TYPE_FLAC,  /**< @brief FLAC decoder */
    DECODER_TYPE_ALAC,  /**< @brief ALAC decoder */    
    DECODER_TYPE_AC3,  /**< @brief ALAC decoder */
    DECODER_TYPE_OPUS,
...
typedef enum {
    ...
    PARSER_TYPE_BY_PASS,/**< @brief parser will work in by pass mode*/
 ...
 */
typedef enum {
    AUDIOSRC_FAKE,                  /**< @brief Fake Device for test */
    AUDIOSRC_PCMRTOS,
 ...
 */
typedef enum {
    AUDIO_SINK_DEVICE_TYPE_FAKE,       /** < @brief Fake Device for test */
...
/*!
 * @brief StreamMsgType
 * @details MESSAGE_UNKNOWN     Unknown
 * @details MESSAGE_EOS         End-of-stream reached in a pipeline. The
 ...
 *                              again.
 * @details MESSAGE_ERROR       An error occured. Whe the application receives
 *                              an error message it should stop playback of the
 *                              pipeline and not assume that more data will be
 *                              played.
 * @details MESSAGE_WARNING     A warning occured.
 * @details MESSAGE_INFO        An info message occured
 * @details MESSAGE_BUFFERING   The pipeline is buffering. When the application
 ...
 * @details MESSAGE_STATE_CHANGED A state change happened
 *
 * The different message types that are available.
 */
typedef enum {
    MESSAGE_UNKNOWN       = 0,           /**< @brief Unknown */
    MESSAGE_EOS           = GET_BIT (0), /**< @brief End-of-stream reached */
    MESSAGE_ERROR         = GET_BIT (1), /**< @brief An error occured */
    MESSAGE_WARNING       = GET_BIT (2), /**< @brief A warning occured */
    MESSAGE_INFO          = GET_BIT (3), /**< @brief An info message occured */
    MESSAGE_BUFFERING     = GET_BIT (4), /**< @brief Pipeline is buffering */
...
/*!
 * Album Art Object
 * Album Art associated with an album or track
 */
...
/*!
 * Track Info Object
 * Holds information regarding an Audio Track
 */
...
/*!
 * StreamImageType
 * Used to hold image data and specify format
 */
typedef struct {
    int8_t    *image_buffer;
...
/*!
  * Property structure
  * Used to set/get elements properties
  */
typedef struct {
    uint16_t prop;
    uintptr_t val;
...
/*!
 * Streamer Arguments
 * Structure for passing input arguments to the streamer task
