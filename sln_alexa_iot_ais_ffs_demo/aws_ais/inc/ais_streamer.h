...
#define AWS_AUDIO_BUFFER_SIZE               (40 * 1024)
#define AWS_AUDIO_START_THRESHOLD           (5 * 1024)
#define AWS_AUDIO_BUFFER_UNDERRUN_THRESHOLD (15 * 1024)
 ...
 *
 * This function returns how much audio data including the field of OPUS frame header, in bytes, occupies the internal
 * source ringbuffer.
 *
 * @param handle Pointer to input handle
...
/*!
 * @brief Get streamer audio raw data buffer size of queued data
 *
 * This function returns how much audio raw data, in bytes, occupies the internal
 * source ringbuffer.
 *
 * @param handle Pointer to input handle
 * @returns Number of bytes audio raw data queued in ringbuffer
 */
