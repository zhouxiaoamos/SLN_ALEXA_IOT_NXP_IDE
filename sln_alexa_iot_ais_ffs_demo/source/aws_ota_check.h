...
#define APP_VECTOR_TABLE_APP_A (EXAMPLE_FLEXSPI_AMBA_BASE + FICA_IMG_APP_A_ADDR)
#define APP_VECTOR_TABLE_APP_B (EXAMPLE_FLEXSPI_AMBA_BASE + FICA_IMG_APP_B_ADDR)
