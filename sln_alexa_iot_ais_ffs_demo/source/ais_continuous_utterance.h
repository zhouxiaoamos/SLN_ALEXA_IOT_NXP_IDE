...
/** @brief Sets aux backup buffer for memory swap during memory movement
 *  @param buffer[in]      Specify the aux backup buffer
 *  @param buffer_size[in] Specify the aux backup buffer size
 *  @return Void
 */
