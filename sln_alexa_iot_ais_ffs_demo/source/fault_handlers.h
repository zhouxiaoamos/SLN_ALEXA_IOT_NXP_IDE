...
/**
 * @brief Read fault context from flash file mgmt and print it to the console, if it exists
 *
 * @return                fault_ret_t
 */
...
/**
 * @brief Write fault context in flash file mgmt
 *
 * @param fault_status[in]   Pointer to a fault_status_t structure describing the fault register status
 * @return                   fault_ret_t
 */
fault_ret_t fault_context_set(fault_status_t *fault_status);

/**
 * @brief Erase fault context stored in flash file mgmt
 *
 * @return                SLN_FLASH_MGMT_OK on success, SLN_FLASH_MGMT error code otherwise
 */
