...
void BOARD_InitLED(void) {
  ...
  /* GPIO configuration of USER_LED on GPIO_EMC_06  */
  gpio_pin_config_t USER_LED_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  gpio_pin_config_t USER_LED_G_config ={
	      .direction = kGPIO_DigitalOutput,
	      .outputLogic = 1U,
	      .interruptMode = kGPIO_NoIntmode

  };
  gpio_pin_config_t USER_LED_B_config ={
	      .direction = kGPIO_DigitalOutput,
	      .outputLogic = 1U,
	      .interruptMode = kGPIO_NoIntmode
  ...
  /* Initialize GPIO functionality on GPIO_EMC_06 */
  GPIO_PinInit(GPIO4, 6U, &USER_LED_config);
  GPIO_PinInit(GPIO4, 8U, &USER_LED_G_config);
  GPIO_PinInit(GPIO1, 0U, &USER_LED_B_config);

  IOMUXC_SetPinMux(
      IOMUXC_GPIO_EMC_06_GPIO4_IO06,        /* GPIO_EMC_06 is configured as GPIO$_IO06 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_EMC_08_GPIO4_IO08,        /* GPIO_EMC_06 is configured as GPIO$_IO06 */
  ...
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_B0_00_GPIO1_IO00,        /* GPIO_EMC_06 is configured as GPIO$_IO06 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */                                /* Software Input On Field: Input Path is determined by functionality */

  IOMUXC_GPR->GPR29 = ((IOMUXC_GPR->GPR29 &
    (~(IOMUXC_GPR_GPR29_GPIO_MUX4_GPIO_SEL_MASK))) /* Mask bits to zero which are setting */
      | IOMUXC_GPR_GPR29_GPIO_MUX4_GPIO_SEL(0x00U) /* GPIO1 and GPIO6 share same IO MUX function, GPIO_MUX1 selects one GPIO function: 0x00U */
    );
  IOMUXC_SetPinConfig(
